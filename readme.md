# My Openclaw Assistant - Makima
My goal with my first openclaw assistant is to keep me on track with my goals. Of course I've used many tools and apps in the past. But nothing really sticks since everything is so disjointed, an app here, an app there. Everything on different platforms in siloed installations. Openclaw helps solve the problem by providing just one interface that you can infinitely customize. Premium LLM tokens is the current bottleneck to running the bot autonomously 24/7, also not having a project that has some good ROI.

hardware:
- mac mini 16gb

linkedin posts:
- [first day with openclaw](https://www.linkedin.com/posts/flauta_my-first-day-with-openclaw-felt-like-discovering-activity-7436912746522136577-umTl?) 
...
skills I've added so far
  - daily dashboard
  - daily bootup morning routine
  - daily evening routine
  - backup through git
  - news feed
  - youtube summarizer
  - personal journaling
  - openclaw pov journaling
  - job scraper
